!(function(g) {
        ...
        tablesorter: new function() {
            ...
            function p(a, b, d) {
                ...
                var h = a.config
                  , c = h.textExtraction
                  , f = ""
                  , f = "simple" === c ? h.supportsTextContent ? b.textContent : g(b).text() : "function" === typeof c ? c(b, a, d) : "object" === typeof c && c.hasOwnProperty(d) ? c[d](b, a, d) : h.supportsTextContent ? b.textContent : g(b).text();
                return g.trim(f)
            }
            function x(a) {
                    ...
                    f = 0; f < y; f++) {
                        ...
                        if (!g)
                            a: {
                                ...
                                r = d;
                                g = -1;
                                for (var A = f, k = void 0, m = e.parsers.length, t = !1, v = "", k = !0; "" === v && k; )
                                    g++,
                                    r[g] ? (t = r[g].cells[A],
                                    v = p(l, t, A),
                                    l.config.debug && c("Checking if value was empty on row " + g + ", column: " + A + ': "' + v + '"')) : k = !1;
                                for (; 0 <= --m; )
                                    if ((k = e.parsers[m]) && "text" !== k.id && k.is && k.is(v, l, t)) {
                                        g = k;
                                        break a
                                    }
            ...
            function B(a, b) {
                ...
                if (!m(f)) {
                    ...
                    for (t = 0; t < h.length; t++)
                        if (l = g(h[t]),
                        l.length && !l.hasClass(d.cssInfoBlock)) {
            ...
            function E(a) {
                ...
                for (f = 0; f < c.length; f++)
                    ...
                    l = 0; l < n.length; l++) {
                        ...
                        for (e = 0; e < b[k].length + 1; e++)
                            if ("undefined" === typeof b[k][e]) {
                                v = e;
                                break
                            }
                        d[m] = v;
            ...
            function H(a) {
                ...
                h = f.length;
                for (b = 0; b < h; b++)
                    if (2 !== f[b][1] && (a = c.$headers.not(".sorter-false").filter('[data-column="' + f[b][0] + '"]' + (1 === h ? ":last" : "")),
                    a.length))
                        for (d = 0; d < a.length; d++)
                            a[d].sortDisabled || (a.eq(d).addClass(l[f[b][1]]),
                            r.length && r.filter('[data-column="' + f[b][0] + '"]').eq(d).addClass(l[f[b][1]]))
            }
            function L(a) {
            ...
            function M(a, b) {
                ...
                g.each(e, function(a, b) {
                    ...
                    if (c = f.headerList[d[0]])
                        f.sortList.push(d),
                        h = g.inArray(d[1], c.order),
                        c.count = 0 <= h ? h : d[1] % (f.sortReset ? 3 : 2)
                })
            }
            function N(a, b, d) {
                ...
                if (l) {
                    ...
                    h = b.order[b.count];
                    if (2 > h && (f.sortList.push([c, h]),
                    1 < b.colSpan))
                        for (d = 1; d < b.colSpan; d++)
                            f.sortList.push([c + d, h])
                } else if (f.sortAppend && 1 < f.sortList.length && e.isValueInArray(f.sortAppend[0][0], f.sortList) && f.sortList.pop(),
                e.isValueInArray(c, f.sortList))
                    for (d = 0; d < f.sortList.length; d++)
                        b = f.sortList[d],
                        h = f.headerList[b[0]],
                        b[0] === c && (b[1] = h.order[h.count],
                        2 === b[1] && (f.sortList.splice(d, 1),
                        h.count = -1));
                else if (h = b.order[b.count],
                2 > h && (f.sortList.push([c, h]),
                1 < b.colSpan))
                    for (d = 1; d < b.colSpan; d++)
                        f.sortList.push([c + d, h]);
            ...
            function I(a) {
                ...
                if (!s.serverSideSorting && !m(s.cache)) {
                    ...
                    for (d = 0; d < C; d++)
                        l = s.cache[d].colMax,
                        n = (g = s.cache[d].normalized) && g[0] ? g[0].length - 1 : 0,
                        g.sort(function(d, g) {
                            for (b = 0; b < B; b++) {
                                f = z[b][0];
                                q = z[b][1];
                                ...
                                if ("" === t[f] && 0 !== h)
                                    return ("boolean" === typeof h ? h ? 1 : -1 : -h || -1) * (v ? 1 : -1);
                                (c = /n/i.test(s.parsers && s.parsers[f] ? s.parsers[f].type || "" : "")) && s.strings[f] ? (c = "boolean" === typeof s.string[s.strings[f]] ? (v ? 1 : -1) * (s.string[s.strings[f]] ? -1 : 1) : s.strings[f] ? s.string[s.strings[f]] || 0 : 0,
                                u = s.numberSorter ? s.numberSorter(w[f], t[f], v, l[f], a) : e.sortNumeric(w[f], t[f], c, l[f])) : u = "function" === typeof x ? x(w[f], t[f], v, f, a) : "object" === typeof x && x.hasOwnProperty(f) ? x[f](w[f], t[f], v, f, a) : e.sortNatural(w[f], t[f]);
                                if (u)
                                    return u
                            }
                            return d[n] - g[n]
            ...
            function K(a) {
                ...
                b.$headers.find(b.selectorSort).add(b.$headers.filter(b.selectorSort)).unbind("mousedown.tablesorter mouseup.tablesorter sort.tablesorter keypress.tablesorter").bind("mousedown.tablesorter mouseup.tablesorter sort.tablesorter keypress.tablesorter", function(d, h) {
                    if (!(1 !== (d.which || d.button) && !/sort|keypress/.test(d.type) || "keypress" === d.type && 13 !== d.which || "mouseup" === d.type && !0 !== h && 250 < (new Date).getTime() - c)) {
                        if ("mousedown" === d.type)
                            ...
                            "INPUT" === d.target.tagName ? "" : !b.cancelSelection;
                ...
                d.unbind("sortReset update updateRows updateCell updateAll addRows sorton appendCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave ".split(" ").join(".tablesorter ")).bind("sortReset.tablesorter", function(d) {
                    ...
                    c = g(c)[0];
                    n.length && 0 <= h && (y = n.eq(h).find("tr").index(w),
                    m = c.cellIndex,
                    n = b.cache[h].normalized[y].length - 1,
                    b.cache[h].row[a.config.cache[h].normalized[y][n]] = w,
                    b.cache[h].normalized[y][m] = b.parsers[m].format(p(a, c, m), a, c, m),
                    G(d, e, k))
                }).bind("addRows.tablesorter", function(c, e, g, k) {
                    c.stopPropagation();
                    var n = e.filter("tr").length
                      , y = []
                      , m = e[0].cells.length
                      , w = d.find("tbody").index(e.parents("tbody").filter(":first"));
                    b.parsers || x(a);
                    for (c = 0; c < n; c++) {
                        for (h = 0; h < m; h++)
            ...
            e.processTbody = function(a, b, d) {
                if (d)
                    return a.isProcessing = !0,
                    b.before('<span class="tablesorter-savemyplace"/>'),
                    d = g.fn.detach ? b.detach() : b.remove();
            ...
            e.destroy = function(a, b, d) {
                ...
                if (a.hasInitialized) {
                    ...
                    var c = g(a)
                      , k = a.config
                      , f = c.find("thead:first")
                      , l = f.find("tr." + e.css.headerRow).removeClass(e.css.headerRow + " " + k.cssHeaderRow)
                      , m = c.find("tfoot:first > tr").children("th, td");
            ...
            e.replaceAccents = function(a) {
                ...
                if (!e.characterRegex) {
                    ...
                    for (b in c)
                        "string" === typeof b && (d += c[b],
                        e.characterRegexArray[b] = RegExp("[" + c[b] + "]", "g"));
            ...
            e.applyWidget = function(a, b) {
                ...
                g.each(d.widgets || [], function(a, b) {
                    (p = e.getWidgetById(b)) && p.id && (p.priority || (p.priority = 10),
                    m[a] = p)
                }),
                m.sort(function(a, b) {
                ...
                g.each(m, function(e, f) {
                    if (f) {
                        if (b || !d.widgetInit[f.id])
                            f.hasOwnProperty("options") && (c = a.config.widgetOptions = g.extend(!0, {}, f.options, c),
                            d.widgetInit[f.id] = !0),
                            f.hasOwnProperty("init") && f.init(a, f, d, c);
                        !b && f.hasOwnProperty("format") && f.format(a, d, c, !1)
                    }
                }));
                d.debug && (l = d.widgets.length,
                k("Completed " + (!0 === b ? "initializing " : "applying ") + l + " widget" + (1 !== l ? "s" : ""), f))
            }
            ;
            e.refreshWidgets = function(a, b, d) {
                ...
                for (h = 0; h < m; h++)
                    l[h] && l[h].id && (b || 0 > g.inArray(l[h].id, f)) && (k.debug && c("Refeshing widgets: Removing " + l[h].id),
                    l[h].hasOwnProperty("remove") && (l[h].remove(a, k, k.widgetOptions),
                    k.widgetInit[l[h].id] = !1));
    ...
    p.addParser({
        ...
        format: function(c, k) {
            var m = k.config;
            c && (c = g.trim(m.ignoreCase ? c.toLocaleLowerCase() : c),
            c = m.sortLocaleCompare ? p.replaceAccents(c) : c);
            return c
        },
        type: "text"
    });
    ...
    p.addWidget({
        ...
        format: function(c, k, m) {
            ...
            for (c = 0; c < D.length; c++)
                u = D.eq(c),
                C = u.children("tr").length,
                1 < C && (z = 0,
                u = u.children("tr:visible"),
                u.each(function() {
                    x = g(this);
        ...
        remove: function(c, k, m) {
            ...
            for (m = 0; m < k.length; m++)
                p = g.tablesorter.processTbody(c, k.eq(m), !0),
                p.children().removeClass(x),
                g.tablesorter.processTbody(c, p, !1)
        }
    })
}
)(jQuery);
